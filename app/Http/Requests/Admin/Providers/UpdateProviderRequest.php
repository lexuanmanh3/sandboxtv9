...
class UpdateProviderRequest extends FormRequest
{
    ...
    {
        $providerId = $this->route('provider')?->id ?? $this->input('id');
        ...
        return [
            ...
            'ma_ncc' => [
                ...
                'max:50',
                'regex:/^[A-Za-z0-9_]+$/',
                Rule::unique('nha_cung_cap', 'ma_ncc')->ignore($providerId),
            ],
            'ten_ncc' => ['required', 'string', 'max:150'],
            'nha_cung_cap_cha_id' => ['nullable', 'integer', 'exists:nha_cung_cap,id', Rule::notIn([$providerId])],
    ...
    public function messages(): array
    {
        return [
            ...
            'nha_cung_cap_cha_id.not_in' => 'Nhà cung cấp cha không thể là chính nhà cung cấp này.',
